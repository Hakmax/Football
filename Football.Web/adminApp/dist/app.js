...
var common_service_1 = __webpack_require__(67);
...
var clubs_service_1 = __webpack_require__(328);
var shared_service_1 = __webpack_require__(58);
var shared_api_service_1 = __webpack_require__(327);
var ClubEditorComponent = /** @class */ (function () {
    function ClubEditorComponent(router, activatedRouter, clubsService, sharedService, sharedApi, cd) {
        this.router = router;
    ...
    ClubEditorComponent.prototype.loadClub = function () {
        var _this = this;
        this.sharedService.showPreloader();
        this.clubsService.getClub(this.clubId).subscribe(function (res) {
            _this.club = Object.assign({}, res);
            _this.editedClub = res;
            _this.loadCountries();
        });
    };
    ClubEditorComponent.prototype.loadCountries = function () {
        var _this = this;
        this.sharedService.showPreloader();
        this.sharedApi.getCountries().subscribe(function (res) {
            _this.countries = res;
            _this.club.Country = res.find(function (x) { return x.Id == _this.club.Country.Id; });
            _this.editedClub.Country = res.find(function (x) { return x.Id == _this.club.Country.Id; });
            console.log(_this.editedClub.Country);
            _this.cd.detectChanges();
        });
    };
    ClubEditorComponent.prototype.cancelClubChanges = function () {
        this.editedClub = Object.assign({}, this.club);
    };
    ClubEditorComponent.prototype.dateChanged = function (event) {
        console.log(event);
    };
    ClubEditorComponent = __decorate([
        core_1.Component({
            template: __webpack_require__(1050)
        }),
        __metadata("design:paramtypes", [router_1.Router, router_1.ActivatedRoute,
            clubs_service_1.ClubsService, shared_service_1.SharedService,
            shared_api_service_1.SharedApiService, core_1.ChangeDetectorRef])
    ], ClubEditorComponent);
    return ClubEditorComponent;
}());
exports.ClubEditorComponent = ClubEditorComponent;
//# sourceMappingURL=club.editor.component.js.map
...
module.exports = "<div *ngIf=\"editedClub\">\r\n    <section class=\"content-header\">\r\n        <h1>\r\n            {{club.Name}}\r\n        </h1>\r\n        <ol class=\"breadcrumb\">\r\n            <li class=\"breadcrumb-item active\">\r\n                <i class=\"fa fa-th-list\"></i><a routerLink=\"../..\"\r\n                                                [queryParams]=\"{country:club.Country.Id}\">Клубы</a>\r\n            </li>\r\n        </ol>\r\n    </section>\r\n\r\n    <section class=\"content\">\r\n        <div class=\"row\">\r\n            <div class=\"col col-xl-12\">\r\n                <div class=\"box\">\r\n                    <form #form=\"ngForm\">\r\n                        <div class=\"box-body\">\r\n\r\n                            <div class=\"form-group\">\r\n                                <label>Наименование</label>\r\n                                <input type=\"text\" class=\"form-control\"\r\n                                        name=\"editedClubName\" required [(ngModel)]=\"editedClub.Name\" />\r\n                            </div>\r\n                            <div class=\"form-group\">\r\n                                <label>Страна</label>\r\n                                <select class=\"form-control\" [(ngModel)]=\"editedClub.Country\" name=\"ts\">\r\n                                    <option *ngFor=\"let item of countries\" [ngValue]=\"item\">\r\n                                        {{item.Name}}\r\n                                    </option>\r\n                                </select>\r\n                            </div>\r\n                            <div class=\"form-group\">\r\n                                <label>Дата основания</label>\r\n                                <input type=\"date\" class=\"form-control\" [ngModel]=\"editedClub.ClubCreationDate|date:'yyyy-MM-dd'\"\r\n                                       (ngModelChange)=\"editedClub.ClubCreationDate=$event\"\r\n                                        name=\"editedClubDate\"/>\r\n                            </div>\r\n                        </div>\r\n                        <div class=\"box-footer\">\r\n                            <button class=\"btn btn-default\" (click)=\"cancelClubChanges()\">Отмена</button>\r\n                            <button class=\"btn btn-success pull-right\" [disabled]=\"form.invalid\">ОК</button>\r\n                        </div>\r\n                        <pre>{{editedClub|json}}</pre>\r\n                    </form>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </section>\r\n</div>\r\n\r\n";
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(2);
var simple_modal_holder_component_1 = __webpack_require__(232);
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(2);
var ngx_simple_modal_1 = __webpack_require__(84);
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(2);
var simple_modal_options_1 = __webpack_require__(653);
var simple_modal_wrapper_component_1 = __webpack_require__(233);
...
var rxjs_1 = __webpack_require__(57);
var authContext_service_1 = __webpack_require__(68);
...
var core_1 = __webpack_require__(2);
var authContext_service_1 = __webpack_require__(68);
var userAuth_service_1 = __webpack_require__(101);
...
var http_1 = __webpack_require__(52);
var common_service_1 = __webpack_require__(67);
var SharedApiService = /** @class */ (function () {
    function SharedApiService(http) {
        this.http = http;
        this.ApiUrl = common_service_1.CommonService.ApiUrl + "common/";
    }
    SharedApiService.prototype.getCountries = function () {
        return this.http.get(this.ApiUrl + "getcountries").map(function (res) { return res.json(); });
    };
    SharedApiService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http])
    ], SharedApiService);
    return SharedApiService;
}());
exports.SharedApiService = SharedApiService;
//# sourceMappingURL=shared-api.service.js.map
...
var ClubsService = /** @class */ (function () {
    function ClubsService(http) {
        this.http = http;
        this.ApiUrl = common_service_1.CommonService.ApiUrl + "clubs/";
    }
    ClubsService.prototype.getClubs = function (countryId) {
        var url = this.ApiUrl + "getall";
        if (countryId)
            url += "/" + countryId;
        return this.http.get(url).map(function (res) { return res.json(); });
    };
    ClubsService.prototype.getClub = function (clubId) {
        return this.http.get(this.ApiUrl + ("/" + clubId)).map(function (res) { return res.json(); });
    };
...
var SharedAdminModule = /** @class */ (function () {
    ...
    SharedAdminModule = __decorate([
        core_1.NgModule({
            imports: [http_1.HttpModule],
            providers: [shared_service_1.SharedService, shared_api_service_1.SharedApiService]
        })
    ], SharedAdminModule);
    return SharedAdminModule;
}());
exports.SharedAdminModule = SharedAdminModule;
//# sourceMappingURL=shared-admin.module.js.map
...
var app_module_1 = __webpack_require__(648);
...
var ngx_simple_modal_1 = __webpack_require__(84);
var common_module_1 = __webpack_require__(656);
//import { CountriesComponent } from "./pages/countries/countries.component";
var authPageGuard_1 = __webpack_require__(926);
var confirm_dialog_1 = __webpack_require__(148);
var app_component_1 = __webpack_require__(928);
var auth_component_1 = __webpack_require__(931);
var userAuthorized_guard_1 = __webpack_require__(324);
var pages_module_1 = __webpack_require__(934);
...
var simple_modal_holder_component_1 = __webpack_require__(232);
var simple_modal_wrapper_component_1 = __webpack_require__(233);
var simple_modal_service_1 = __webpack_require__(139);
var simple_modal_service_factory_1 = __webpack_require__(654);
...
Object.defineProperty(exports, "__esModule", { value: true });
var simple_modal_module_1 = __webpack_require__(652);
exports.SimpleModalModule = simple_modal_module_1.SimpleModalModule;
var simple_modal_component_1 = __webpack_require__(655);
...
var userAuth_service_1 = __webpack_require__(101);
var authContext_service_1 = __webpack_require__(68);
var authContext_model_1 = __webpack_require__(929);
var shared_service_1 = __webpack_require__(58);
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(2);
var auth_model_1 = __webpack_require__(932);
var userAuth_service_1 = __webpack_require__(101);
var shared_service_1 = __webpack_require__(58);
var authContext_service_1 = __webpack_require__(68);
var router_1 = __webpack_require__(29);
...
var pages_routing_module_1 = __webpack_require__(936);
var shared_admin_module_1 = __webpack_require__(329);
var PagesModule = /** @class */ (function () {
    function PagesModule() {
    }
    PagesModule = __decorate([
        core_1.NgModule({
            imports: [pages_routing_module_1.PagesRoutingModule, router_1.RouterModule, common_1.CommonModule, shared_admin_module_1.SharedAdminModule],
...
var pages_component_1 = __webpack_require__(325);
var userAuthorized_guard_1 = __webpack_require__(324);
var countries_module_1 = __webpack_require__(937);
var user_profile_module_1 = __webpack_require__(946);
var clubs_module_1 = __webpack_require__(949);
var routes = router_1.RouterModule.forChild([
    {
        path: "pages", component: pages_component_1.PagesComponent, canActivate: [userAuthorized_guard_1.UserAuthorizedGuard], children: [
            ...
            { path: "clubs", loadChildren: function () { return clubs_module_1.ClubsModule; } }
        ]
    }
]);
...
var common_1 = __webpack_require__(11);
var forms_1 = __webpack_require__(23);
var countries_component_1 = __webpack_require__(938);
var countries_service_1 = __webpack_require__(149);
var countries_communication_service_1 = __webpack_require__(150);
var country_editor_component_1 = __webpack_require__(940);
var routes = router_1.RouterModule.forChild([
    {
...
var router_1 = __webpack_require__(29);
var platform_browser_1 = __webpack_require__(44);
var city_model_1 = __webpack_require__(941);
var countries_service_1 = __webpack_require__(149);
var country_details_model_1 = __webpack_require__(942);
var shared_service_1 = __webpack_require__(58);
var countries_communication_service_1 = __webpack_require__(150);
var common_1 = __webpack_require__(11);
var city_editor_component_1 = __webpack_require__(326);
...
Object.defineProperty(exports, "__esModule", { value: true });
var base_model_1 = __webpack_require__(943);
...
var router_1 = __webpack_require__(29);
var forms_1 = __webpack_require__(23);
var user_profile_component_1 = __webpack_require__(947);
...
var forms_1 = __webpack_require__(23);
var router_1 = __webpack_require__(29);
var clubs_component_1 = __webpack_require__(950);
var shared_admin_module_1 = __webpack_require__(329);
var clubs_service_1 = __webpack_require__(328);
var club_editor_component_1 = __webpack_require__(1049);
var routes = router_1.RouterModule.forChild([
    { path: "", component: clubs_component_1.ClubsComponent },
    { path: "edit/:clubId", component: club_editor_component_1.ClubEditorComponent }
]);
var ClubsModule = /** @class */ (function () {
    ...
    ClubsModule = __decorate([
        core_1.NgModule({
            declarations: [clubs_component_1.ClubsComponent, club_editor_component_1.ClubEditorComponent],
            providers: [clubs_service_1.ClubsService],
            imports: [common_1.CommonModule, forms_1.FormsModule, router_1.RouterModule, routes, shared_admin_module_1.SharedAdminModule]
        })
    ], ClubsModule);
    return ClubsModule;
}());
...
var ClubsComponent = /** @class */ (function () {
    function ClubsComponent(sharedApi, sharedService, clubsService, router, activatedRouter) {
        var _this = this;
        this.sharedApi = sharedApi;
        this.sharedService = sharedService;
        this.clubsService = clubsService;
        ...
        this.filter = new ClubsComponentFilter();
        console.log("clubs constructor");
        this.activatedRouter.queryParams.subscribe(function (res) {
            _this.filter.country = res["country"];
    ...
    ClubsComponent.prototype.ngOnInit = function () {
        ...
        this.sharedApi.getCountries().subscribe(function (res) {
            _this.countries = res;
            if (_this.filter.country)
                _this.selectedCountry = _this.countries.find(function (x) { return x.Id == _this.filter.country; });
            _this.sharedService.hidePreloader();
            _this.loadClubs();
        });
    };
    ClubsComponent.prototype.countryChanged = function () {
    ...
    ClubsComponent.prototype.loadClubs = function () {
        var _this = this;
        this.sharedService.showPreloader();
        var countryId = this.selectedCountry != null ? this.selectedCountry.Id : null;
        this.clubsService.getClubs(countryId).subscribe(function (res) {
            _this.clubs = res;
            _this.sharedService.hidePreloader();
        });
    };
    ClubsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [shared_api_service_1.SharedApiService, shared_service_1.SharedService,
            clubs_service_1.ClubsService, router_1.Router, router_1.ActivatedRoute])
    ], ClubsComponent);
    return ClubsComponent;
}());
exports.ClubsComponent = ClubsComponent;
var ClubsComponentFilter = /** @class */ (function () {
    function ClubsComponentFilter() {
    }
    return ClubsComponentFilter;
}());
exports.ClubsComponentFilter = ClubsComponentFilter;
...
module.exports = "<section class=\"content-header\">\r\n    <h1>\r\n        Клубы\r\n    </h1>\r\n    <ol class=\"breadcrumb\">\r\n        <li class=\"breadcrumb-item active\"><i class=\"fa fa-th-list\"></i>Клубы</li>\r\n    </ol>\r\n</section>\r\n\r\n<section class=\"content\">\r\n    <div class=\"row\">\r\n        <div class=\"col col-xl-12\">\r\n            <select class=\"form-control\" [(ngModel)]=\"selectedCountry\" (change)=\"countryChanged()\">\r\n                <option [ngValue]=\"null\">Все</option>\r\n                <option *ngFor=\"let item of countries\" [ngValue]=\"item\">\r\n                    {{item.Name}}\r\n                </option>\r\n            </select>\r\n\r\n            <div class=\"box\">\r\n                <div class=\"box-header with-border\">\r\n                    <div class=\"box-tools pull-right\">\r\n                        <a class=\"btn btn-primary\" [routerLink]=\"['create']\">Создать</a>\r\n                    </div>\r\n                    <!-- /.box-tools -->\r\n                </div>\r\n\r\n                <div class=\"box-body\">\r\n\r\n                    <table class=\"table\">\r\n                        <thead>\r\n                            <tr>\r\n                                <th style=\"width:2%\">Id</th>\r\n                                <th>Наименование</th>\r\n                                <td style=\"width:165px\"></td>\r\n                            </tr>\r\n                        </thead>\r\n                        <tbody>\r\n                            <tr *ngFor=\"let item of clubs\">\r\n                                <td>{{item.Id}}</td>\r\n                                <td>{{item.Name}}</td>\r\n                                <td>\r\n                                    <button class=\"btn btn-danger\" (click)=\"deleteClub()\">Удалить</button>\r\n                                    <button class=\"btn btn-primary\" [routerLink]=\"['edit', item.Id]\">Изменить</button>\r\n                                </td>\r\n                            </tr>\r\n                        </tbody>\r\n                    </table>\r\n                </div>\r\n            </div>\r\n\r\n        </div>\r\n    </div>\r\n</section>";
